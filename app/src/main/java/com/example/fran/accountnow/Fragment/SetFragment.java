...
import com.example.fran.accountnow.LoginActivity;
import com.example.fran.accountnow.MainActivity;
                        ...
                        dialog.setPositiveButton("确定",
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        File db = new File("/data/data/com.example.fran.accountnow/databases/charges.db");
                                        db.delete();
